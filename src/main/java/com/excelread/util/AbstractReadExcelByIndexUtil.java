 ...
 * @version V1.1.0
 */
public abstract class AbstractReadExcelByIndexUtil extends DefaultHandler {
    /**
     * 共享字符串表
     */
     ...
     * @throws Exception 异常
     */
    public void processByIndex(InputStream inputStream, int sheetId) throws Exception {
